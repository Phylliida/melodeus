...
from mel_aec_audio import ensure_stream_started, write_playback_pcm, shared_sample_rate
...
class SynchronizedThinkingSoundPlayer:
    ...
    def _generate_thinking_frames(self):
      """Generate a single pulse followed by a single silence segment."""
        ...
        pulse = (carrier * envelope * 32767).astype(np.int16)
    ...
    async def _play_helper(self):
        ...
        while True:
            write_playback_pcm(self.audio_frames, self.sample_rate)
